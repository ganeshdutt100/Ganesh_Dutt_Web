...
const GaneshResume = () => {
  return (
    <div className="min-h-screen bg-gray-900 text-white pt-24 pb-10 px-4 md:px-8">
      ...
      <div
        className="max-w-5xl mx-auto bg-gray-800/50 backdrop-blur-xl border border-gray-700 rounded-2xl shadow-2xl overflow-hidden"
        data-aos="fade-up"
      >
        {/* --- 1. HEADER SECTION --- */}
        <div className="bg-gradient-to-r from-gray-900 to-gray-800 p-8 border-b border-gray-700 flex flex-col md:flex-row items-center gap-8">
          ...
          <div
            className="w-32 h-32 md:w-40 md:h-40 rounded-full border-4 border-blue-500 overflow-hidden shadow-lg shrink-0"
            data-aos="zoom-in"
            data-aos-delay="200"
          >
            <img
          ...
          >
            ...
            <p className="text-gray-400 text-sm mt-2 max-w-2xl">
              Creative Frontend Developer with experience in building responsive
              and user-friendly web applications. Proficient in React, Next.js,
          ...
          <a
            ...
            className="bg-blue-600 hover:bg-blue-500 text-white px-6 py-3 rounded-full font-bold flex items-center gap-2 shadow-lg transition transform hover:scale-105"
            data-aos="fade-left"
            data-aos-delay="500"
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-12">
          ...
          <div
            className="md:col-span-4 bg-gray-800/60 p-6 md:p-8 border-r border-gray-700 space-y-8"
            data-aos="fade-right"
            data-aos-delay="200"
          >
            {/* Contact Info */}
            ...
            <div data-aos="fade-right" data-aos-delay="400">
              ...
              <div className="flex flex-wrap gap-2">
                {[
                  ...
                  <span
                    key={skill}
                    className="px-3 py-1 bg-gray-700/50 border border-gray-600 rounded text-xs text-white"
                  >
                    {skill}
                  </span>
                ))}
            ...
            <div data-aos="fade-left" data-aos-delay="500">
              ...
              <ul className="text-xs text-gray-300 space-y-2 list-disc pl-4">
                <li>
                  1st Position in Agile Activity (Team Leader) at 4Achievers.
                </li>
              ...
              <div className="space-y-8 border-l-2 border-gray-700 ml-3 pl-8 relative">
                ...
                >
                  ...
                  <p className="text-blue-400 text-sm font-semibold mb-2">
                    I3infosoft Pvt Ltd| March 2025 - Present
                  </p>
                  <ul className="text-gray-400 text-sm space-y-2 list-disc pl-4">
                    <li>
                      Leveraged React.js, Next.js, Material UI, and Tailwind for
                      frontend development.
                    </li>
                    <li>
                      Created solutions for projects like Brajyatraa web, gaming
                      apps, and real estate platforms.
                    </li>
                    <li>
                      Built visually appealing responsive interfaces for optimal
                      performance.
                    </li>
                    <li>
                      Integrated third-party libraries to enhance project
                      efficiency.
                    </li>
                  </ul>
                </div>
                ...
                >
                  ...
                  <p className="text-gray-400 text-sm font-semibold mb-2">
                    4Achievers Pvt. Ltd | Oct 2023 - March 2025
                  </p>
                  <ul className="text-gray-400 text-sm space-y-2 list-disc pl-4">
                    <li>
                      Developed training materials for HTML, CSS, JS, React.js,
                      and Core Java.
                    </li>
                    <li>
                      Conducted training sessions and assessed learners through
                      live projects.
                    </li>
                    <li>
                      Provided technical support and mentored students in web
                      development.
                    </li>
                  </ul>
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                >
                  ...
                  <p className="text-gray-400 text-sm mb-4">
                    ...
                    program. Its official website offers extensive information
                    about the mission's goals, spacecraft, instruments, and
                    updates. Visitors can access images, videos, and data to
                    study the Moon's geology and minerals. It's a valuable
                    resource for researchers, students, and lunar science
                    enthusiasts.
                  </p>
                  <a
                    href="https://ganeshdutt100.github.io/Mission_Chandrayaan/"
                    target="_blank"
                    rel="noreferrer"
                ...
                >
                  ...
                  <p className="text-xs text-blue-400 mb-3">
                    ReactJS, Tailwind, Context API
                  </p>
                  <p className="text-gray-400 text-sm mb-4">
                    E-commerce app with Sign-in, Cart, Product filtering, and
                    automatic subtotal calculation.
                  </p>
                  <a
                    href="https://complete-amazon.netlify.app"
                    target="_blank"
                    rel="noreferrer"
                    className="text-sm text-white underline hover:text-blue-400"
                  >
